...
use crate::timetable::Subject::{Art, Chemistry, EnglishAdvanced, EnglishBasic, Ethics, French, GermanBasic, History, Lf10, Lf11, Lf6_7_9, Lf8, Literature, MathAdvanced, MathBasic, PhysicalEducation, Physics, Russian};

/// https://geschuetzt.bszet.de/s-lk-vw/Stundenplaene/DuBAS/IGD%2021.pdf
pub const IGD21: Lazy<Timetable> = Lazy::new(|| HashMap::from([
  (Monday, vec![
