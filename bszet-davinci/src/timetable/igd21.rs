...
use crate::timetable::Subject::{
    Art, Chemistry, EnglishAdvanced, EnglishBasic, Ethics, French, GermanBasic, History, Lf10,
    Lf11, Lf6_7_9, Lf8, Literature, MathAdvanced, MathBasic, PhysicalEducation, Physics, Russian,
};
